...
import { Bell, Search, User, Settings, LogOut, Shield, Crown, Menu } from 'lucide-react';
    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-14 md:h-16 flex items-center justify-between">
          ...
          <Link 
            to="/" 
            className="flex items-center space-x-2 font-bold text-lg md:text-xl text-primary hover:text-primary/80 transition-colors"
          >
            <div className={`w-6 h-6 md:w-8 md:h-8 rounded-lg ${getRoleColor()} flex items-center justify-center text-white font-bold text-xs md:text-sm`}>
              CS
            </div>
            {!isMobile && <span>CloudScribe</span>}
          </Link>
